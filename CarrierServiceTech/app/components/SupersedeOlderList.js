...
export default class SupersedeOlderList extends Component{
  constructor(props){
    super(props);
    const ds = new ListView.DataSource({rowHasChanged: (r1, r2) => r1 !== r2});
    this.state = {
        older : stringConstant.carrierConstClass.OLDER,
        dataSource: ds.cloneWithRows(dataResource.Alternative_Part_Older_List),
  ...
  render(){
    ...
    return(
      <View style = {styles.container}> 
          <Text style={[globalStyles.headerTxt2, {marginLeft:15,color:'#06273F'}]}>{this.state.older}</Text>            
