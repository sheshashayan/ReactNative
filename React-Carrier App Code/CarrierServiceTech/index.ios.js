...
import GlobalLiteratureFilters from "./app/components/GlobalLiteratureFilters";
...
function configureStore(initialState){
  ...
  return createStore(searchedThing, initialState, enhancer);
